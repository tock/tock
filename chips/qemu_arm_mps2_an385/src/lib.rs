...
///
/// Boards name their core through here rather than reaching for `cortexm3`
...
/// table below.
pub use cortexm3::CortexM3;

use cortexm3::{CortexMVariant, initialize_ram_jump_to_main, unhandled_interrupt};
