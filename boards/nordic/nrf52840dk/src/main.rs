...
pub unsafe fn reset_handler() {
    ...
    let gpio_pins = static_init!(
        ...
        [
            ...
            static_init!(kernel::hil::gpio::InterruptValueWrapper,
                         kernel::hil::gpio::InterruptValueWrapper::new(&nrf5x::gpio::PORT[10])).finalize(),
            static_init!(kernel::hil::gpio::InterruptValueWrapper,
                         kernel::hil::gpio::InterruptValueWrapper::new(&nrf5x::gpio::PORT[9])).finalize(),
            static_init!(kernel::hil::gpio::InterruptValueWrapper,
                         kernel::hil::gpio::InterruptValueWrapper::new(&nrf5x::gpio::PORT[8])).finalize(),
            static_init!(kernel::hil::gpio::InterruptValueWrapper,
                         kernel::hil::gpio::InterruptValueWrapper::new(&nrf5x::gpio::PORT[7])).finalize(),
            static_init!(kernel::hil::gpio::InterruptValueWrapper,
                         kernel::hil::gpio::InterruptValueWrapper::new(&nrf5x::gpio::PORT[6])).finalize(),
            static_init!(kernel::hil::gpio::InterruptValueWrapper,
                         kernel::hil::gpio::InterruptValueWrapper::new(&nrf5x::gpio::PORT[5])).finalize(),
            static_init!(kernel::hil::gpio::InterruptValueWrapper,
                         kernel::hil::gpio::InterruptValueWrapper::new(&nrf5x::gpio::PORT[1])).finalize(),
            static_init!(kernel::hil::gpio::InterruptValueWrapper,
                         kernel::hil::gpio::InterruptValueWrapper::new(&nrf5x::gpio::PORT[0])).finalize(),
        ]
    );

    // LEDs
    let led_pins = static_init!(
        [(&'static kernel::hil::gpio::Pin, capsules::led::ActivationMode); 4],
        [
            (
    ...
    let button_pins = static_init!(
        [(&'static kernel::hil::gpio::InterruptValuePin, capsules::button::GpioMode); 4],
        [
            (
                static_init!(kernel::hil::gpio::InterruptValueWrapper,
