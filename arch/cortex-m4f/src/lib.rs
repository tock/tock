...
pub mod mpu {
    ...
    /// Create a new MPU for the Cortex-M4F hardware.
    ///
    /// # Safety
    ///
    /// Callers must ensure the hardware is a valid Cortex-M4F chip and that the
...
impl cortexm::CortexMVariant for CortexM4F {
...
pub mod syscall {
    pub type SysCall = cortexm::syscall::SysCall<crate::CortexM4F>;
}
