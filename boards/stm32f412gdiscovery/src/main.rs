...
unsafe fn setup_dma(
    dma: &stm32f412g::dma::dma1::Dma1,
    dma_streams: &'static [stm32f412g::dma::Stream<stm32f412g::dma::dma1::Dma1>; 8],
    usart2: &'static stm32f412g::usart::Usart<stm32f412g::dma::dma1::Dma1>,
) {
    use stm32f412g::dma::dma1::Dma1Peripheral;
...
unsafe fn get_peripherals() -> (
    ...
    &'static stm32f412g::dma::dma1::Dma1<'static>,
) {
    ...
    let dma1 = static_init!(
        stm32f412g::dma::dma1::Dma1,
        stm32f412g::dma::dma1::Dma1::new(rcc)
    );
    let dma2 = static_init!(
        stm32f412g::dma::dma2::Dma2,
        stm32f412g::dma::dma2::Dma2::new(rcc)
    );
