//! ST77XX8080 8080 Parallel bus Screen
//!
//! Usage
//! -----
//!
...
pub struct ST77XX8080<'a, A: Alarm<'a>, B: Bus8080<'a>, P: Pin> {
    bus: &'a B,
    alarm: &'a A,
    dc: Option<&'a P>,
    reset: &'a P,
...
impl<'a, A: Alarm<'a>, B: Bus8080<'a>, P: Pin> ST77XX8080<'a, A, B, P> {
    pub fn new(
        bus: &'a B,
        alarm: &'a A,
        dc: Option<&'a P>,
...
impl<'a, A: Alarm<'a>, B: Bus8080<'a>, P: Pin> Driver for ST77XX8080<'a, A, B, P> {
...
impl<'a, A: Alarm<'a>, B: Bus8080<'a>, P: Pin> screen::ScreenSetup for ST77XX8080<'a, A, B, P> {
...
impl<'a, A: Alarm<'a>, B: Bus8080<'a>, P: Pin> screen::Screen for ST77XX8080<'a, A, B, P> {
...
impl<'a, A: Alarm<'a>, B: Bus8080<'a>, P: Pin> time::AlarmClient for ST77XX8080<'a, A, B, P> {
    fn fired(&self) {
        self.do_next_op();
    }
}

impl<'a, A: Alarm<'a>, B: Bus8080<'a>, P: Pin> bus8080::Client for ST77XX8080<'a, A, B, P> {
