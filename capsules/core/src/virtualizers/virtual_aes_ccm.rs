...
impl<'a, A: AES128<'a> + AES128Ctr + AES128CBC + AES128ECB> VirtualAES128CCM<'a, A> {
    ...
    fn encode_ccm_buffer(
        ...
        let auth_len = (off.div_ceil(AES128_BLOCK_SIZE) / AES128_BLOCK_SIZE) * AES128_BLOCK_SIZE;
        ...
        let enc_len = (off.div_ceil(AES128_BLOCK_SIZE) / AES128_BLOCK_SIZE) * AES128_BLOCK_SIZE;
