...
pub trait ProcessStandardDebug {
...
impl<C: Chip, D: 'static + ProcessStandardDebug + Default> Process for ProcessStandard<'_, C, D> {
...
impl<C: 'static + Chip, D: 'static + ProcessStandardDebug + Default> ProcessStandard<'_, C, D> {
