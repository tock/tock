$(BUILD_APP_DIR)/tmp006.elf: $(call rwildcard,$(SRC_DIR)apps/tmp006/,*.c) $(BUILD_DIR)/arch.o $(BUILD_APP_DIR)/firestorm.o $(BUILD_APP_DIR)/tock.o $(BUILD_APP_DIR)/crt1.o $(BUILD_APP_DIR)/sys.o $(BUILD_APP_DIR)/tmp006.o $(APP_LIBC)
	@echo "Building $@"
