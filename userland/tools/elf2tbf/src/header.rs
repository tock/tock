...
impl TbfHeader {
	...
	pub fn create(&mut self, minimum_ram_size: u32, appstate: bool, package_name: String
		) -> usize {
	...
	fn inject_checksum(&self, mut header_buf: io::Cursor<vec::Vec<u8>>) -> io::Result<(io::Cursor<vec::Vec<u8>>)> {
