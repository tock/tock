...
register_bitfields![u32,
    ...
    pub MSCR [
        ...
        /// Source Signal Select. Selects the pad function (GPIO, ALT1..ALT4).
        /// See RM §16.3.12 field `2-0 SSS` and RM §16.4.13 field `2-0 SSS`.
    ...
    pub IMCR [
        ...
        /// the associated destination (chip pin) — see RM §16.3.13 field
        /// `2-0 SSS` and RM §16.4.14 field `2-0 SSS`.
        SSS  OFFSET(0) NUMBITS(3) []
    ]
];
...
/// Re-export the MSCR SSS field value enum as a public alternate-function type.
///
/// This avoids duplicating the `GPIO = 0`, `ALT1 = 1`, ... definitions while
...
/// chip-specific SIUL2 instance layout and the pin-to-function mapping.
