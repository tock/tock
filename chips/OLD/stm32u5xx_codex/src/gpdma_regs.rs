...
//   /home/vic/Dev/Work/tockFULL/tock/tools/svd2regs/svd2regs.py --svd /home/vic/Dev/Work/tockFULL/tock/chips/stm32u5xx/STM32U545.svd GPDMA --group --save /home/vic/Dev/Work/tockFULL/tock/chips/stm32u5xx/src/dma_regs.rs
...
const GPDMA1_BASE: StaticRef<GpdmaRegisters> =
    unsafe { StaticRef::new(0x40020000 as *const GpdmaRegisters) };


const SEC_GPDMA1_BASE: StaticRef<GpdmaRegisters> =
    unsafe { StaticRef::new(0x50020000 as *const GpdmaRegisters) };
