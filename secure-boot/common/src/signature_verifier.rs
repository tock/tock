...
pub fn verify_signature<C: BoardConfig, IO: BootloaderIO>(
    ...
    // io.debug("Constructing Signature");
    // Construct signature
    ...
    // io.debug("Verifying Signature against hash");
