...
define_registers! {
    /// Clock control
    unsafe struct ClockRegisters {
        /// Start HFXO crystal oscillator
        tasks_hfclkstart: WriteOnly<u32, Control::Register> = 0x000,
        /// Stop HFXO crystal oscillator
        tasks_hfclkstop: WriteOnly<u32, Control::Register> = 0x004,
        /// Start LFCLK
        tasks_lfclkstart: ReadWrite<u32, Control::Register> = 0x008,
        /// Stop LFCLK
        tasks_lfclkstop: WriteOnly<u32, Control::Register> = 0x00C,
        /// Start calibration of LFRC
        tasks_cal: WriteOnly<u32, Control::Register> = 0x010,
        /// Start calibration timer
        tasks_ctstart: WriteOnly<u32, Control::Register> = 0x014,
        /// Stop calibration timer
        tasks_ctstop: WriteOnly<u32, Control::Register> = 0x018,
        /// HFXO crystal oscillator started
        events_hfclkstarted: ReadOnly<u32, Status::Register> = 0x100,
        /// LFCLK started
        events_lfclkstarted: ReadOnly<u32, Status::Register> = 0x104,
        /// Calibration of LFRC completed
        events_done: ReadOnly<u32, Status::Register> = 0x10C,
        /// Calibration timer timeout
        events_ctto: ReadOnly<u32, Status::Register> = 0x110,
        /// Enable interrupt
        intenset: ReadWrite<u32, Interrupt::Register> = 0x304,
        /// Disable interrupt
        intenclr: ReadWrite<u32, Interrupt::Register> = 0x308,
        /// Status indicating that HFCLKSTART task has been triggered
        hfclkrun: ReadOnly<u32, Status::Register> = 0x408,
        /// HFCLK status
        hfclkstat: ReadWrite<u32, HfClkStat::Register> = 0x40C,
        /// Status indicating that LFCLKSTART task has been triggered
        lfclkrun: ReadOnly<u32, Control::Register> = 0x414,
        /// LFCLK status
        lfclkstat: ReadWrite<u32, LfClkStat::Register> = 0x418,
        /// Copy of LFCLKSRC register, set when LFCLKSTART task was triggered
        lfclksrccopy: ReadOnly<u32, LfClkSrcCopy::Register> = 0x41C,
        /// Clock source for the LFCLK
        lfclksrc: ReadWrite<u32, LfClkSrc::Register> = 0x518,
        /// Calibration timer interval
        ctiv: ReadWrite<u32, Ctiv::Register> = 0x538,
        /// Clocking options for the trace port debug interface
        traceconfig: ReadWrite<u32, TraceConfig::Register> = 0x55C,
    }
}
...
const CLOCK_BASE: ClockRegisters = ClockRegisters {
