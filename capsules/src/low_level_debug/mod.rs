...
use kernel::{CommandReturn, ErrorCode, Grant, GrantDefault, ProcessId, ProcessUpcallFactory};
...
impl GrantDefault for AppData {
    fn grant_default(_process_id: ProcessId, _upcall_factory: &mut ProcessUpcallFactory) -> Self {
        AppData {
