...
$(BUILD_PLATFORM_DIR)/libsam4l.rlib: $(call rwildcard,$(SRC_DIR)chips/sam4l/src,*.rs) $(BUILD_PLATFORM_DIR)/libcortexm4.rlib $(BUILD_PLATFORM_DIR)/libcore.rlib $(BUILD_PLATFORM_DIR)/libhil.rlib $(BUILD_PLATFORM_DIR)/libcommon.rlib $(BUILD_PLATFORM_DIR)/libmain.rlib | $(BUILD_PLATFORM_DIR)
	@echo "Building $@"
	@$(RUSTC) $(RUSTC_FLAGS) --out-dir $(BUILD_PLATFORM_DIR) $(SRC_DIR)chips/sam4l/src/lib.rs
