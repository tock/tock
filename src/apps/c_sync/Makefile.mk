$(BUILD_DIR)/apps/c_sync.elf: $(call rwildcard,$(SRC_DIR)apps/c_sync/,*.c) $(BUILD_DIR)/arch.o $(BUILD_DIR)/apps/firestorm.o $(BUILD_DIR)/apps/tock.o $(BUILD_DIR)/apps/crt1.o $(APP_LIBC)
