...
static mut PROCESSES: [Option<kernel::procs::Process<'static>>; NUM_PROCS] = [None, None, None, None];
...
struct Hail {
    ...
    sensys: &'static sensys::Sensys<'static, VirtualMuxAlarm<'static, sam4l::ast::Ast<'static>>, sam4l::gpio::GPIOPin>,
...
pub unsafe fn reset_handler() {
    ...
    let sensys = static_init!(
        sensys::Sensys<'static, VirtualMuxAlarm<'static, sam4l::ast::Ast>, sam4l::gpio::GPIOPin>,
        sensys::Sensys::new(sensys_virtual_alarm, isl29035, &sam4l::gpio::PA[13]));
