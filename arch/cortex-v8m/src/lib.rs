...
extern "C" {
    ...
    pub fn systick_handler_arm_v8m();
}

#[cfg(any(doc, all(target_arch = "arm", target_os = "none")))]
core::arch::global_asm!(
    "
    .section .systick_handler_arm_v8m, \"ax\"
    .global systick_handler_arm_v8m
    .thumb_func
  systick_handler_arm_v8m:
...
extern "C" {
    ...
    pub fn svc_handler_arm_v8m();
}

#[cfg(any(doc, all(target_arch = "arm", target_os = "none")))]
core::arch::global_asm!(
    "
    .section .svc_handler_arm_v8m, \"ax\"
    .global svc_handler_arm_v8m
    .thumb_func
  svc_handler_arm_v8m:
...
core::arch::global_asm!(
        "
    .section .generic_isr_arm_v8m, \"ax\"
    .global generic_isr_arm_v8m
    .thumb_func
  generic_isr_arm_v8m:
...
#[cfg(any(doc, all(target_arch = "arm", target_os = "none")))]
pub unsafe fn switch_to_user_arm_v8m(
...
unsafe extern "C" fn hard_fault_handler_arm_v8m_kernel(
...
extern "C" {
    ...
    pub fn hard_fault_handler_arm_v8m();
}
...
core::arch::global_asm!(
    "
        .section .hard_fault_handler_arm_v8m, \"ax\"
        .global hard_fault_handler_arm_v8m
        .thumb_func
    hard_fault_handler_arm_v8m:
        mov    r2, 0     // r2 = 0
        ...
        bx lr",
    estack = sym _estack,
    kernel_hard_fault_handler = sym hard_fault_handler_arm_v8m_kernel,
);
...
pub unsafe extern "C" fn systick_handler_arm_v8m() {
    unimplemented!()
}

#[cfg(not(any(doc, all(target_arch = "arm", target_os = "none"))))]
pub unsafe extern "C" fn svc_handler_arm_v8m() {
    unimplemented!()
}

#[cfg(not(any(doc, all(target_arch = "arm", target_os = "none"))))]
pub unsafe extern "C" fn generic_isr_arm_v8m() {
    unimplemented!()
}

#[cfg(not(any(doc, all(target_arch = "arm", target_os = "none"))))]
pub unsafe extern "C" fn switch_to_user_arm_v8m(
...
#[cfg(not(any(doc, all(target_arch = "arm", target_os = "none"))))]
pub unsafe extern "C" fn hard_fault_handler_arm_v8m() {
    unimplemented!()
}
