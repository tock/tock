...
struct STM32F3Discovery {
    ...
    gpio: &'static core_capsules::gpio::GPIO<'static, stm32f303xc::gpio::Pin<'static>>,
    led: &'static core_capsules::led::LedDriver<
        'static,
        LedHigh<'static, stm32f303xc::gpio::Pin<'static>>,
        8,
    >,
    button: &'static core_capsules::button::Button<'static, stm32f303xc::gpio::Pin<'static>>,
    ninedof: &'static extra_capsules::ninedof::NineDof<'static>,
    l3gd20: &'static extra_capsules::l3gd20::L3gd20Spi<'static>,
    lsm303dlhc: &'static extra_capsules::lsm303dlhc::Lsm303dlhcI2C<'static>,
...
impl SyscallDriverLookup for STM32F3Discovery {
        ...
        F: FnOnce(Option<&dyn kernel::syscall::SyscallDriver>) -> R,
    {
        match driver_num {
            ...
            extra_capsules::l3gd20::DRIVER_NUM => f(Some(self.l3gd20)),
            extra_capsules::lsm303dlhc::DRIVER_NUM => f(Some(self.lsm303dlhc)),
...
pub unsafe fn main() {
    ...
    let l3gd20 = components::l3gd20::L3gd20Component::new(
        ...
        board_kernel,
        extra_capsules::l3gd20::DRIVER_NUM,
    )
    ...
    let temp = static_init!(
        ...
        extra_capsules::temperature::TemperatureSensor::new(l3gd20, grant_temperature)
    );
    ...
    let lsm303dlhc = components::lsm303dlhc::Lsm303dlhcI2CComponent::new(
        ...
        None,
        board_kernel,
        extra_capsules::lsm303dlhc::DRIVER_NUM,
    )
