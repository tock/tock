...
pub struct Uarte<'a> {
    ...
    tx_buffer: kernel::common::cells::OptionalCell<&'static mut  [u8]>,
    tx_len: Cell<usize>,
    tx_remaining_bytes: Cell<usize>,
    rx_client: OptionalCell<&'a dyn uart::ReceiveClient>,
    rx_buffer: kernel::common::cells::OptionalCell<&'static mut  [u8]>,
...
impl<'a> Uarte<'a> {
    ...
    pub const fn new() -> Uarte<'a> {
        Uarte {
            ...
            tx_buffer: kernel::common::cells::OptionalCell::empty(),
            tx_len: Cell::new(0),
            tx_remaining_bytes: Cell::new(0),
            rx_client: OptionalCell::empty(),
            rx_buffer: kernel::common::cells::OptionalCell::empty(),
