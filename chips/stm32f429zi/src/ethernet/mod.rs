...
//! # Usage
//!
//! In order to use the Ethernet peripheral, a 50MHz reference clock is needed. It can be provided
//! by an external clock or it can be generated by the board.
//!
...
//!
//! Inside the **setup_ethernet_gpios** function in the board main file, uncomment the lines
//! corresponding to MCO1. Then connect the MCO1 pin (PA8) to the Ethernet reference clock pin
//! (PA1) and add the lines above.
