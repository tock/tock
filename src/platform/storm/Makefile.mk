...
$(BUILD_PLATFORM_DIR)/libstorm.a: $(call rwildcard,$(SRC_DIR)platform/storm/src,*.rs) $(BUILD_PLATFORM_DIR)/libsam4l.rlib $(PLATFORM_DEPS) | $(BUILD_PLATFORM_DIR)
	@echo "Building $@"
	@$(RUSTC) $(RUSTC_FLAGS) -C lto -o $@ $(SRC_DIR)platform/storm/src/lib.rs
	@$(OBJDUMP) $(OBJDUMP_FLAGS) $@ > $(BUILD_PLATFORM_DIR)/kernel.lst

$(BUILD_PLATFORM_DIR)/kernel.elf: $(BUILD_PLATFORM_DIR)/ctx_switch.o $(BUILD_PLATFORM_DIR)/libstorm.a | $(BUILD_PLATFORM_DIR)
