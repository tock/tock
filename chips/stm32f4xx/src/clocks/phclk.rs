...
impl ClockInterface for PeripheralClock<'_> {
    fn is_enabled(&self) -> bool {
        ...
        match self.clock {
            PeripheralClockType::AHB1(ref v) => match v {
                HCLK1::ETHMACPTPEN => rcc.is_enabled_ethernet_macptp_clock(),
                HCLK1::ETHMACRXEN => rcc.is_enabled_ethernet_macrx_clock(),
                HCLK1::ETHMACTXEN => rcc.is_enabled_ethernet_mactx_clock(),
                HCLK1::ETHMACEN => rcc.is_enabled_ethernet_mac_clock(),
    ...
    fn enable(&self) {
        ...
        match self.clock {
            PeripheralClockType::AHB1(ref v) => match v {
                HCLK1::ETHMACPTPEN => rcc.enable_ethernet_macptp_clock(),
                HCLK1::ETHMACRXEN => rcc.enable_ethernet_macrx_clock(),
                HCLK1::ETHMACTXEN => rcc.enable_ethernet_mactx_clock(),
                HCLK1::ETHMACEN => rcc.enable_ethernet_mac_clock(),
                HCLK1::DMA1 => {
    ...
    fn disable(&self) {
        ...
        match self.clock {
            PeripheralClockType::AHB1(ref v) => match v {
                HCLK1::ETHMACPTPEN => rcc.disable_ethernet_macptp_clock(),
                HCLK1::ETHMACRXEN => rcc.disable_ethernet_macrx_clock(),
                HCLK1::ETHMACTXEN => rcc.disable_ethernet_mactx_clock(),
                HCLK1::ETHMACEN => rcc.disable_ethernet_mac_clock(),
                HCLK1::DMA1 => {
