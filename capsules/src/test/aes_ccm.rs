...
use kernel::hil::symmetric_encryption::{AES128_BLOCK_SIZE, CCM_NONCE_LENGTH, AES128CCM, CCMClient};
...
static BEACON_SECURED: [u8; 34] = [0x08, 0xD0, 0x84, 0x21, 0x43, 0x01, 0x00, 0x00, 0x00, 0x00,
                                   ...
                                   0x00, 0x00, 0x51, 0x52, 0x53, 0x54, 0x22, 0x3B, 0xC1, 0xEC,
                                   0x84, 0x1A, 0xB5, 0x53];

// IEEE 802.15.4-2015, Annex C.2.1.2, Unsecured beacon frame with auxiliary
// security header included and the security bits set
static BEACON_UNSECURED: [u8; 26] = [0x08, 0xD0, 0x84, 0x21, 0x43, 0x01, 0x00, 0x00, 0x00, 0x00,
                                     0x48, 0xDE, 0xAC, 0x02, 0x05, 0x00, 0x00, 0x00, 0x55, 0xCF,
...
static DATA_SECURED: [u8; 30] = [0x69, 0xDC, 0x84, 0x21, 0x43, 0x02, 0x00, 0x00, 0x00, 0x00, 0x48,
                                 ...
                                 0x05, 0x00, 0x00, 0x00, 0xD4, 0x3E, 0x02, 0x2B];
...
static MAC_SECURED: [u8; 38] = [0x2B, 0xDC, 0x84, 0x21, 0x43, 0x02, 0x00, 0x00, 0x00, 0x00, 0x48,
                                ...
                                0xAC, 0x06, 0x05, 0x00, 0x00, 0x00, 0x01, 0xD8, 0x4F, 0xDE, 0x52,
                                0x90, 0x61, 0xF9, 0xC6, 0xF1];
