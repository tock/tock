...
impl<'a, C: ProcessManagementCapability> ProcessConsole<'a, C> {
    ...
    pub fn print_memory_map(&self, process: &dyn ProcessType) {
        // Flash
    ...
    pub fn print_kernel_memory_map(&self, kernel_info: KernelInfo) {
        ...
        let stack_size = stack_start - text_start;
        ...
        let text_size = text_start - rodata_start;
        ...
        let rodata_size = rodata_start - rodata_bottom;
        ...
        let _ = write(
            ...
            format_args!(
             ...
             \r\n             │   RoData     {:6}\
             \r\n  {:#010X} ┼───────────────────────────────",
                rodata_start, rodata_size, rodata_bottom
            ),
        );
        self.write_bytes(&(w.buf)[..w.size]);
        w.clear();
        ...
        let init_size = init_bottom - init_start;
        ...
        let _ = write(
            ...
            format_args!(
             ...
             \r\n  {:#010X} ┼───────────────────────────────\
             \r\n",
                init_bottom, init_size, init_start
            ),
        );
        self.write_bytes(&(w.buf)[..w.size]);
        w.clear();
