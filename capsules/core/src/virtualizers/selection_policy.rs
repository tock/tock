...
/// Trait that determines which device to choose next
/// from the list of devices in the virtualizer.
pub trait SelectionPolicy<I>: Default {
...
/// Round-robin virtualizer selection policy.
///
/// Selects the first ready device based on the last access position. It stores
/// the position of the last selected device to introduce fairness.
#[derive(Default)]
