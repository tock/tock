...
$(BUILD_PLATFORM_DIR)/main.o: $(MAIN_DEPS) | $(BUILD_PLATFORM_DIR)
	@echo "Building $@"
	@$(RUSTC) $(RUSTC_FLAGS) -C lto --emit obj -o $@ $(SRC_DIR)main/main.rs

$(BUILD_PLATFORM_DIR)/main.S: $(MAIN_DEPS) | $(BUILD_PLATFORM_DIR)
	@echo "Building $@"
	@$(RUSTC) $(RUSTC_FLAGS) -C lto --emit asm -o $@ $(SRC_DIR)main/main.rs

$(BUILD_PLATFORM_DIR)/main.ir: $(MAIN_DEPS) | $(BUILD_PLATFORM_DIR)
	@echo "Building $@"
