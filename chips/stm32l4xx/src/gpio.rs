...
struct GpioRegisters {
    ...
    brr: WriteOnly<u32, BRR::Register>,
...
register_bitfields![u32,
    ...
    ASCR[
        /// Port x analog switch control I/O pin y (y = 15 to 0)
...
const GPIOG_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x48001800 as *const GpioRegisters) };
...
/// "Alternate Function"" section of the STM32L4xx datasheet[^1].
///
...
impl<'a> GpioPorts<'a> {
    pub fn new(clocks: &'a dyn Stm32l4Clocks, exti: &'a exti::Exti<'a>) -> Self {
        Self {
            ports: [
                Port {
                ...
                Port {
                    ...
                    clock: PortClock(phclk::PeripheralClock::new(
                        phclk::PeripheralClockType::AHB2(phclk::HCLK2::GPIOD),
                        clocks,
                    )),
                },
                Port {
                    ...
                    clock: PortClock(phclk::PeripheralClock::new(
                        phclk::PeripheralClockType::AHB2(phclk::HCLK2::GPIOE),
                        clocks,
                    )),
                },
                Port {
                    ...
                    clock: PortClock(phclk::PeripheralClock::new(
                        phclk::PeripheralClockType::AHB2(phclk::HCLK2::GPIOF),
                        clocks,
                    )),
                },
                Port {
                    ...
                    clock: PortClock(phclk::PeripheralClock::new(
                        phclk::PeripheralClockType::AHB2(phclk::HCLK2::GPIOG),
                        clocks,
                    )),
                },
                Port {
