...
struct ArtyE21 {
    ...
    gpio: &'static core_capsules::gpio::GPIO<'static, arty_e21_chip::gpio::GpioPin<'static>>,
    ...
    led: &'static core_capsules::led::LedDriver<
        ...
        3,
    >,
    button: &'static core_capsules::button::Button<'static, arty_e21_chip::gpio::GpioPin<'static>>,
