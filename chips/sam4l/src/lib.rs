...
#![crate_name = "sam4l"]
#![crate_type = "rlib"]
#![feature(repr_align,attr_literals,const_cell_new,const_atomic_usize_new,const_atomic_bool_new,const_atomic_u32_new,const_ptr_null_mut,integer_atomics,try_from)]
