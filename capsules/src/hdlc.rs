...
pub trait Hdlc {
    fn send(&self, address: u8, message: &'static mut [u8]) -> (ReturnCode, &'static mut [u8]);
}

pub struct HighLevelDataLinkControl<'a> {
...
impl<'a> uart::TransmitClient for HighLevelDataLinkControl<'a> {
...
impl<'a> uart::ReceiveClient for HighLevelDataLinkControl<'a> {
    fn received_buffer(
        &self,
...
impl<'a> Hdlc for HighLevelDataLinkControl<'a> {
