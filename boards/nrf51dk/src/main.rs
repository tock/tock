...
pub unsafe fn reset_handler() {
    ...
    let ble_radio = static_init!(
     ...
     nrf5x::ble_advertising_driver::BLE::new(
        ...
        256/8);
    nrf5x::ble_advertising_hil::BleAdvertisementDriver::set_rx_client(&nrf51::radio::RADIO,
                                                                      ble_radio);
    nrf5x::ble_advertising_hil::BleAdvertisementDriver::set_tx_client(&nrf51::radio::RADIO,
                                                                      ble_radio);
