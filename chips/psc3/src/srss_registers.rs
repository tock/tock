...
register_structs! {
    pub SrssRegisters {
        ...
        (0x100 => pub clk_dsi_select_0: ReadWrite<u32, CLK_DSI_SELECT::Register>),
        /// Clock DSI Select Register
        (0x104 => pub clk_dsi_select_1: ReadWrite<u32, CLK_DSI_SELECT::Register>),
        /// Clock DSI Select Register
        (0x108 => pub clk_dsi_select_2: ReadWrite<u32, CLK_DSI_SELECT::Register>),
        /// Clock DSI Select Register
        (0x10C => pub clk_dsi_select_3: ReadWrite<u32, CLK_DSI_SELECT::Register>),
        /// Clock DSI Select Register
        (0x110 => pub clk_dsi_select_4: ReadWrite<u32, CLK_DSI_SELECT::Register>),
        /// Clock DSI Select Register
        (0x114 => pub clk_dsi_select_5: ReadWrite<u32, CLK_DSI_SELECT::Register>),
        /// Clock DSI Select Register
        (0x118 => pub clk_dsi_select_6: ReadWrite<u32, CLK_DSI_SELECT::Register>),
        (0x11C => _reserved1),
        /// Fast Clock Output Select Register
        (0x140 => pub clk_output_fast: ReadWrite<u32, CLK_OUTPUT_FAST::Register>),
        /// Slow Clock Output Select Register
        (0x144 => pub clk_output_slow: ReadWrite<u32, CLK_OUTPUT_SLOW::Register>),
        /// Clock Calibration Counter 1
        (0x148 => pub clk_cal_cnt1: ReadWrite<u32, CLK_CAL_CNT1::Register>),
        /// Clock Calibration Counter 2
        (0x14C => pub clk_cal_cnt2: ReadWrite<u32, CLK_CAL_CNT2::Register>),
        (0x150 => _reserved2),
        /// SRSS Interrupt Register
        (0x200 => pub srss_intr: ReadWrite<u32, SRSS_INTR::Register>),
        /// SRSS Interrupt Set Register
        (0x204 => pub srss_intr_set: ReadWrite<u32, SRSS_INTR_SET::Register>),
        /// SRSS Interrupt Mask Register
        (0x208 => pub srss_intr_mask: ReadWrite<u32, SRSS_INTR_MASK::Register>),
        /// SRSS Interrupt Masked Register
        (0x20C => pub srss_intr_masked: ReadOnly<u32>),
        (0x210 => _reserved3),
        /// SRSS Additional Interrupt Register
        (0x300 => pub srss_aintr: ReadWrite<u32, SRSS_AINTR::Register>),
        /// SRSS Additional Interrupt Set Register
        (0x304 => pub srss_aintr_set: ReadWrite<u32, SRSS_AINTR_SET::Register>),
        /// SRSS Additional Interrupt Mask Register
        (0x308 => pub srss_aintr_mask: ReadWrite<u32, SRSS_AINTR_MASK::Register>),
        /// SRSS Additional Interrupt Masked Register
        (0x30C => pub srss_aintr_masked: ReadOnly<u32>),
        (0x310 => _reserved4),
        /// Debug Control Register
        (0x404 => pub boot_dlm_ctl: ReadWrite<u32, BOOT_DLM_CTL::Register>),
        /// Debug Control Register 2
        (0x408 => pub boot_dlm_ctl2: ReadWrite<u32, BOOT_DLM_CTL2::Register>),
        /// Debug Status Register
        (0x40C => pub boot_dlm_status: ReadOnly<u32, BOOT_DLM_STATUS::Register>),
        /// Soft Reset Trigger Register
        (0x410 => pub res_soft_ctl: ReadWrite<u32, RES_SOFT_CTL::Register>),
        (0x414 => _reserved5),
        /// Boot Execution Status Register
        (0x418 => pub boot_status: ReadOnly<u32, BOOT_STATUS::Register>),
        (0x41C => _reserved6),
        /// Warm Boot Entry Address
        (0x430 => pub boot_entry: ReadWrite<u32, BOOT_ENTRY::Register>),
        (0x434 => _reserved7),
        /// Hibernate Wakeup Mask Register
        (0x8A0 => pub pwr_hib_wake_ctl: ReadWrite<u32, PWR_HIB_WAKE_CTL::Register>),
        /// Hibernate Wakeup Polarity Register
        (0x8A4 => pub pwr_hib_wake_ctl2: ReadWrite<u32, PWR_HIB_WAKE_CTL2::Register>),
        (0x8A8 => _reserved8),
        /// Hibernate Wakeup Cause Register
        (0x8AC => pub pwr_hib_wake_cause: ReadOnly<u32, PWR_HIB_WAKE_CAUSE::Register>),
        (0x8B0 => _reserved9),
        /// Power Mode Control
        (0x1000 => pub pwr_ctl: ReadWrite<u32, PWR_CTL::Register>),
        /// Power Mode Control 2
        (0x1004 => pub pwr_ctl2: ReadWrite<u32, PWR_CTL2::Register>),
        /// HIBERNATE Mode Register
        (0x1008 => pub pwr_hibernate: ReadWrite<u32, PWR_HIBERNATE::Register>),
        (0x100C => _reserved10),
        /// High Voltage / Low Voltage Detector (HVLVD) Configuration Register
        (0x1020 => pub pwr_lvd_ctl: ReadWrite<u32, PWR_LVD_CTL::Register>),
        (0x1024 => _reserved11),
        // Clock Path Select Registers
        (0x1200 => pub clk_path_select0: ReadWrite<u32, CLK_PATH_SELECT::Register>),
        (0x1204 => pub clk_path_select1: ReadWrite<u32, CLK_PATH_SELECT::Register>),
        (0x1208 => pub clk_path_select2: ReadWrite<u32, CLK_PATH_SELECT::Register>),
        (0x120C => pub clk_path_select3: ReadWrite<u32, CLK_PATH_SELECT::Register>),
        (0x1210 => pub clk_path_select4: ReadWrite<u32, CLK_PATH_SELECT::Register>),
        (0x1214 => pub clk_path_select5: ReadWrite<u32, CLK_PATH_SELECT::Register>),
        (0x1218 => pub clk_path_select6: ReadWrite<u32, CLK_PATH_SELECT::Register>),

        (0x121C => _reserved12),

        // Clock Root Select Registers
        (0x1240 => pub clk_root_select0: ReadWrite<u32, CLK_ROOT_SELECT::Register>),
        (0x1244 => pub clk_root_select1: ReadWrite<u32, CLK_ROOT_SELECT::Register>),
        (0x1248 => pub clk_root_select2: ReadWrite<u32, CLK_ROOT_SELECT::Register>),
        (0x124C => pub clk_root_select3: ReadWrite<u32, CLK_ROOT_SELECT::Register>),
        (0x1250 => pub clk_root_select4: ReadWrite<u32, CLK_ROOT_SELECT::Register>),
        (0x1254 => pub clk_root_select5: ReadWrite<u32, CLK_ROOT_SELECT::Register>),
        (0x1258 => pub clk_root_select6: ReadWrite<u32, CLK_ROOT_SELECT::Register>),

        (0x125C => _reserved13),

        // Clock Root Direct Select Registers
        (0x1280 => pub clk_direct_select0: ReadWrite<u32, CLK_DIRECT_SELECT::Register>),
        (0x1284 => pub clk_direct_select1: ReadWrite<u32, CLK_DIRECT_SELECT::Register>),
        (0x1288 => pub clk_direct_select2: ReadWrite<u32, CLK_DIRECT_SELECT::Register>),
        (0x128C => pub clk_direct_select3: ReadWrite<u32, CLK_DIRECT_SELECT::Register>),
        (0x1290 => pub clk_direct_select4: ReadWrite<u32, CLK_DIRECT_SELECT::Register>),
        (0x1294 => pub clk_direct_select5: ReadWrite<u32, CLK_DIRECT_SELECT::Register>),
        (0x1298 => pub clk_direct_select6: ReadWrite<u32, CLK_DIRECT_SELECT::Register>),

        (0x129C => _reserved14),

        // Clock Supervision (CSV) HF Registers
        (0x1400 => pub csv_hf_csv0_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1404 => pub csv_hf_csv0_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1408 => pub csv_hf_csv0_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),
        (0x140C => _reserved15),
        (0x1410 => pub csv_hf_csv1_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1414 => pub csv_hf_csv1_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1418 => pub csv_hf_csv1_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),
        (0x141C => _reserved16),
        (0x1420 => pub csv_hf_csv2_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1424 => pub csv_hf_csv2_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1428 => pub csv_hf_csv2_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),
        (0x142C => _reserved17),
        (0x1430 => pub csv_hf_csv3_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1434 => pub csv_hf_csv3_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1438 => pub csv_hf_csv3_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),
        (0x143C => _reserved18),
        (0x1440 => pub csv_hf_csv4_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1444 => pub csv_hf_csv4_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1448 => pub csv_hf_csv4_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),
        (0x144C => _reserved19),
        (0x1450 => pub csv_hf_csv5_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1454 => pub csv_hf_csv5_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1458 => pub csv_hf_csv5_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),
        (0x145C => _reserved20),
        (0x1460 => pub csv_hf_csv6_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1464 => pub csv_hf_csv6_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1468 => pub csv_hf_csv6_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),

        (0x146C => _reserved21),

        // General Clock Config
        (0x1500 => pub clk_select: ReadWrite<u32, CLK_SELECT::Register>),
        (0x1504 => _reserved22),
        (0x1518 => pub clk_imo_config: ReadWrite<u32, CLK_IMO_CONFIG::Register>),
        (0x151C => pub clk_eco_config: ReadWrite<u32, CLK_ECO_CONFIG::Register>),
        (0x1520 => pub clk_eco_prescale: ReadWrite<u32, CLK_ECO_PRESCALE::Register>),
        (0x1524 => pub clk_eco_status: ReadOnly<u32, CLK_ECO_STATUS::Register>),
        (0x1528 => _reserved23),
        (0x1530 => pub clk_fll_config: ReadWrite<u32, CLK_FLL_CONFIG::Register>),
        (0x1534 => pub clk_fll_config2: ReadWrite<u32, CLK_FLL_CONFIG2::Register>),
        (0x1538 => pub clk_fll_config3: ReadWrite<u32, CLK_FLL_CONFIG3::Register>),
        (0x153C => pub clk_fll_config4: ReadWrite<u32, CLK_FLL_CONFIG4::Register>),
        (0x1540 => pub clk_fll_status: ReadOnly<u32, CLK_FLL_STATUS::Register>),
        (0x1544 => pub clk_eco_config2: ReadWrite<u32, CLK_ECO_CONFIG2::Register>),
        (0x1548 => pub clk_ilo_config: ReadWrite<u32, CLK_ILO_CONFIG::Register>),
        (0x154C => pub clk_trim_ilo_ctl: ReadWrite<u32, CLK_TRIM_ILO_CTL::Register>),
        (0x1550 => _reserved24),
        (0x1554 => pub clk_mf_select: ReadWrite<u32, CLK_MF_SELECT::Register>),
        (0x1558 => pub clk_mfo_config: ReadWrite<u32, CLK_MFO_CONFIG::Register>),
        (0x155C => _reserved25),
        (0x1560 => pub clk_iho_config: ReadWrite<u32, CLK_IHO_CONFIG::Register>),

        (0x1564 => _reserved26),

        // CSV Reference Control
        (0x1700 => pub csv_ref_sel: ReadWrite<u32, CSV_REF_SEL::Register>),
        (0x1704 => _reserved27),
        (0x1710 => pub csv_ref_csv_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1714 => pub csv_ref_csv_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1718 => pub csv_ref_csv_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),
        (0x171C => _reserved28),
        (0x1720 => pub csv_lf_csv_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1724 => pub csv_lf_csv_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1728 => pub csv_lf_csv_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),
        (0x172C => _reserved29),
        (0x1730 => pub csv_ilo_csv_ref_ctl: ReadWrite<u32, CSV_REF_CTL::Register>),
        (0x1734 => pub csv_ilo_csv_ref_limit: ReadWrite<u32, CSV_REF_LIMIT::Register>),
        (0x1738 => pub csv_ilo_csv_mon_ctl: ReadWrite<u32, CSV_MON_CTL::Register>),

        (0x173C => _reserved30),

        // Resets
        (0x1800 => pub res_cause: ReadOnly<u32, RES_CAUSE::Register>),
        (0x1804 => pub res_cause2: ReadOnly<u32, RES_CAUSE2::Register>),
        (0x1808 => _reserved31),
        (0x1814 => pub res_pxres_ctl: ReadWrite<u32, RES_PXRES_CTL::Register>),

        (0x1818 => _reserved32),

        // DPLL LP0
        (0x1A00 => pub clk_dpll_lp0_config: ReadWrite<u32, CLK_DPLL_LP_CONFIG::Register>),
        (0x1A04 => pub clk_dpll_lp0_config2: ReadWrite<u32, CLK_DPLL_LP_CONFIG2::Register>),
        (0x1A08 => pub clk_dpll_lp0_config3: ReadWrite<u32, CLK_DPLL_LP_CONFIG3::Register>),
        (0x1A0C => pub clk_dpll_lp0_config4: ReadWrite<u32, CLK_DPLL_LP_CONFIG4::Register>),
        (0x1A10 => pub clk_dpll_lp0_config5: ReadWrite<u32, CLK_DPLL_LP_CONFIG5::Register>),
        (0x1A14 => pub clk_dpll_lp0_config6: ReadWrite<u32, CLK_DPLL_LP_CONFIG6::Register>),
        (0x1A18 => pub clk_dpll_lp0_config7: ReadWrite<u32, CLK_DPLL_LP_CONFIG7::Register>),
        (0x1A1C => pub clk_dpll_lp0_status: ReadOnly<u32, CLK_DPLL_LP_STATUS::Register>),

        // DPLL LP1
        (0x1A20 => pub clk_dpll_lp1_config: ReadWrite<u32, CLK_DPLL_LP_CONFIG::Register>),
        (0x1A24 => pub clk_dpll_lp1_config2: ReadWrite<u32, CLK_DPLL_LP_CONFIG2::Register>),
        (0x1A28 => pub clk_dpll_lp1_config3: ReadWrite<u32, CLK_DPLL_LP_CONFIG3::Register>),
        (0x1A2C => pub clk_dpll_lp1_config4: ReadWrite<u32, CLK_DPLL_LP_CONFIG4::Register>),
        (0x1A30 => pub clk_dpll_lp1_config5: ReadWrite<u32, CLK_DPLL_LP_CONFIG5::Register>),
        (0x1A34 => pub clk_dpll_lp1_config6: ReadWrite<u32, CLK_DPLL_LP_CONFIG6::Register>),
        (0x1A38 => pub clk_dpll_lp1_config7: ReadWrite<u32, CLK_DPLL_LP_CONFIG7::Register>),
        (0x1A3C => pub clk_dpll_lp1_status: ReadOnly<u32, CLK_DPLL_LP_STATUS::Register>),

        (0x1A40 => _reserved33),

        // Trims and Security
        (0x2054 => pub tst_xres_secure: ReadWrite<u32, TST_XRES_SECURE::Register>),
        (0x2058 => _reserved34),
        (0x20E0 => pub pwr_trim_pwrsys_ctl: ReadWrite<u32, PWR_TRIM_PWRSYS_CTL::Register>),
        (0x20E4 => pub pwr_trim_pwrsys_ctl2: ReadWrite<u32, PWR_TRIM_PWRSYS_CTL2::Register>),

        (0x20E8 =>  _reserved35),

        (0x301C => pub clk_trim_eco_ctl: ReadWrite<u32, CLK_TRIM_ECO_CTL::Register>),

        (0x3020 =>  _reserved36),

        (0x4000 => pub ram_trim_trim_ram_ctl: ReadWrite<u32, RAM_TRIM_TRIM_RAM_CTL::Register>),
        (0x4004 => pub ram_trim_trim_rom_ctl: ReadWrite<u32, RAM_TRIM_TRIM_ROM_CTL::Register>),

        (0x4008 => _reserved37),

        // DPLL Trims
        (0x4200 => pub clk_trim_dpll_lp0_dpll_lp_ctl: ReadWrite<u32, CLK_TRIM_DPLL_LP_DPLL_LP_CTL::Register>),
        (0x4204 => _reserved38),
        (0x4208 => pub clk_trim_dpll_lp0_dpll_lp_ctl3: ReadWrite<u32, CLK_TRIM_DPLL_LP_DPLL_LP_CTL3::Register>),
        (0x420C => pub clk_trim_dpll_lp0_dpll_lp_ctl4: ReadWrite<u32, CLK_TRIM_DPLL_LP_DPLL_LP_CTL4::Register>),
        (0x4210 => _reserved39),
        (0x421C => pub clk_trim_dpll_lp0_dpll_lp_test4: ReadWrite<u32, CLK_TRIM_DPLL_LP_DPLL_LP_TEST4::Register>),
        (0x4220 => pub clk_trim_dpll_lp1_dpll_lp_ctl: ReadWrite<u32, CLK_TRIM_DPLL_LP_DPLL_LP_CTL::Register>),
        (0x4224 => _reserved40),
        (0x4228 => pub clk_trim_dpll_lp1_dpll_lp_ctl3: ReadWrite<u32, CLK_TRIM_DPLL_LP_DPLL_LP_CTL3::Register>),
        (0x422C => pub clk_trim_dpll_lp1_dpll_lp_ctl4: ReadWrite<u32, CLK_TRIM_DPLL_LP_DPLL_LP_CTL4::Register>),
        (0x4230 => _reserved41),
        (0x423C => pub clk_trim_dpll_lp1_dpll_lp_test4: ReadWrite<u32, CLK_TRIM_DPLL_LP_DPLL_LP_TEST4::Register>),

        (0x4240 => _reserved42),

        // Watchdog (WDT Type A)
        (0xC000 => pub wdt_ctl: ReadWrite<u32, WDT_CTL::Register>),
        (0xC004 => pub wdt_cnt: ReadOnly<u32, WDT_CNT::Register>),
        (0xC008 => pub wdt_match: ReadWrite<u32, WDT_MATCH::Register>),
        (0xC00C => pub wdt_match2: ReadWrite<u32, WDT_MATCH2::Register>),

        (0xC010 => _reserved43),

        // Multi-Counter Watchdog (MCWDT)
        (0xD004 => pub mcwdt_cntlow0: ReadOnly<u32, MCWDT_CNTLOW::Register>),
        (0xD008 => pub mcwdt_cnthigh0: ReadOnly<u32, MCWDT_CNTHIGH::Register>),
        (0xD00C => pub mcwdt_match0: ReadWrite<u32, MCWDT_MATCH::Register>),
        (0xD010 => pub mcwdt_config0: ReadWrite<u32, MCWDT_CONFIG::Register>),
        (0xD014 => pub mcwdt_ctl0: ReadWrite<u32, MCWDT_CTL::Register>),
        (0xD018 => pub mcwdt_intr0: ReadWrite<u32, MCWDT_INTR::Register>),
        (0xD01C => pub mcwdt_intr_set0: ReadWrite<u32, MCWDT_INTR_SET::Register>),
        (0xD020 => pub mcwdt_intr_mask0: ReadWrite<u32, MCWDT_INTR_MASK::Register>),
        (0xD024 => pub mcwdt_intr_masked0: ReadOnly<u32, MCWDT_INTR_MASKED::Register>),
        (0xD028 => pub mcwdt_lock0: ReadWrite<u32, MCWDT_LOCK::Register>),
        (0xD02C => pub mcwdt_lower_limit0: ReadWrite<u32, MCWDT_LOWER_LIMIT::Register>),
        (0xD030 => @END),
    }
}
...
pub CLK_TRIM_ECO_CTL [
    /// Current Trim
    ITRIM OFFSET(16) NUMBITS(6) []
],
pub CLK_TRIM_ILO1_CTL [
...
pub RAM_TRIM_TRIM_RAM_CTL [
    /// N/A
    TRIM OFFSET(0) NUMBITS(32) []
],
pub RAM_TRIM_TRIM_ROM_CTL [
    /// N/A
    TRIM OFFSET(0) NUMBITS(32) []
],
pub CLK_TRIM_DPLL_LP_DPLL_LP_CTL [
...
pub CLK_TRIM_DPLL_LP_DPLL_LP_CTL3 [
...
pub CLK_TRIM_DPLL_LP_DPLL_LP_TEST4 [
