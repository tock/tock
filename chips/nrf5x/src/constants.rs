...
//Shortcuts
pub const RADIO_SHORTS_READY_START: u32 = 0b0001;
pub const RADIO_SHORTS_END_DISABLE: u32 = 0b0010;
pub const RADIO_SHORTS_DISABLED_TXEN: u32 = 0b0100;
pub const RADIO_SHORTS_DISABLED_RXEN: u32 = 0b1000;
