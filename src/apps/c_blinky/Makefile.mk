$(BUILD_APP_DIR)/c_blinky.elf: $(call rwildcard,$(SRC_DIR)apps/c_blinky/,*.c) $(BUILD_DIR)/arch.o $(BUILD_APP_DIR)/firestorm.o $(BUILD_APP_DIR)/tock.o $(BUILD_APP_DIR)/crt1.o $(BUILD_APP_DIR)/sys.o $(APP_LIBC)
