...
use x86_next::mpu::PagingMPU;
use x86_next::registers::bits32::paging::{PD, PT};
use x86_next::support;
use x86_next::{Boundary, InterruptPoller};
...
impl<'a, const PR: u16> Chip for Pc<'a, PR> {
    ...
    #[cfg(target_arch = "x86")]
    fn sleep(&self) {
        use x86_next::registers::bits32::eflags::{self, EFLAGS};
