...
type AES128CTREncryptionOracleDriver =
    capsules_extra::tutorials::signed_sensor_tutorial::encryption_oracle::EncryptionOracleDriver<
        'static,
...
impl SyscallDriverLookup for Platform {
        ...
        F: FnOnce(Option<&dyn kernel::syscall::SyscallDriver>) -> R,
    {
        match driver_num {
            ...
            capsules_extra::tutorials::signed_sensor_tutorial::encryption_oracle::DRIVER_NUM => {
