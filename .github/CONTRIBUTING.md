...
to be written using AI (tools used exclusively for accessibility or translation
are acceptable). Large Language Models often make unverified claims and produce
verbose output. Writing PR comments by hand reduces cognitive burden for
reviewers, incentivizes authors to reflect on generated changes, and keeps
communication succinct. If including AI output is necessary genuinely serves the
purposes of the PR, include it in a [`<details>`][html-details] drawer.
