...
register_structs! {
    pub RadioRegisters {
        ...
        (0x024 => _reserved1),
        /// Start the CCA
        (0x02C => task_ccastart: WriteOnly<u32, Task::Register>),
        /// Stop the CCA
        (0x030 => task_ccastop: WriteOnly<u32, Task::Register>),
        (0x034 => _reserved2),
        ...
        (0x138 => event_framestart: ReadWrite<u32, Event::Register>),
        (0x13C => _reserved5),
        /// Wireless medium in idle - clear to send
        (0x144 => event_ccaidle: ReadWrite<u32, Event::Register>),
        /// Wireless medium busy - do not send
        (0x148 => event_ccabusy: ReadWrite<u32, Event::Register>),
        (0x14C => _reserved6),
        /// Shortcut register
        ...
        (0x644 => mhrmatchconf: ReadWrite<u32, MACHeaderSearch::Register>),
        /// MAC Header Search Pattern Mask
        (0x648 => mhrmatchmas: ReadWrite<u32, MACHeaderMask::Register>),
        (0x64C => _reserved15),
        ...
        (0x66C => ccactrl: ReadWrite<u32, CCAControl::Register>),
        (0x670 => _reserved17),
