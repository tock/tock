...
use x86_next::registers::bits32::paging::{PDEntry, PTEntry, PD, PT};
use x86_next::registers::irq;

use x86_q35_next::pit::{Pit, RELOAD_1KHZ};
use x86_q35_next::{Pc, PcComponent};
...
unsafe extern "cdecl" fn main() {
    ...
    .finalize(x86_q35_next::x86_q35_component_static!());
