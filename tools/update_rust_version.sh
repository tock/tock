...
rustup update nightly --allow-downgrade --component cargo --component clippy \
       --component llvm-tools-preview --component miri --component rls \
       --component rust-analysis --component rust-docs --component rust-src \
       --component rust-std --component rustc --component rustfmt
