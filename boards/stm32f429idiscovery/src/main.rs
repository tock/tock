...
impl Platform for STM32F429IDiscovery {
...
unsafe fn setup_dma() {
    use dma::dma2::{Dma2Peripheral, DMA2};
    use stm32f429zi::dma;
    ...
    let usart1_tx_stream = Dma2Peripheral::USART1_TX.get_stream();
    let usart1_rx_stream = Dma2Peripheral::USART1_RX.get_stream();
