...
pub const BYTES_PER_U128: NonZeroUsize = create_non_zero_usize(
    divide_non_zero_usize(
        BITS_PER_U128,
        BITS_PER_U8,
    )
...
pub const BYTES_PER_U64: NonZeroUsize = create_non_zero_usize(
    divide_non_zero_usize(
        BITS_PER_U64,
        BITS_PER_U8,
    )
...
pub const BYTES_PER_U32: NonZeroUsize = create_non_zero_usize(
    divide_non_zero_usize(
        BITS_PER_U32,
        BITS_PER_U8,
    )
...
pub const BYTES_PER_U16: NonZeroUsize = create_non_zero_usize(
    divide_non_zero_usize(
        BITS_PER_U16,
        BITS_PER_U8,
    )
