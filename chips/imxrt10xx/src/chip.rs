            ...
            loop {
                if let Some(interrupt) = cortexm7::nvic::next_pending() {
                    match interrupt {
                        ...
                        nvic::GPIO1_1 => gpio::PORT[0].handle_interrupt(),
                        nvic::GPIO1_2 => gpio::PORT[0].handle_interrupt(),
                        nvic::GPIO2_1 => gpio::PORT[1].handle_interrupt(),
                        nvic::GPIO2_2 => gpio::PORT[1].handle_interrupt(),
                        nvic::GPIO3_1 => gpio::PORT[2].handle_interrupt(),
                        nvic::GPIO3_2 => gpio::PORT[2].handle_interrupt(),
                        nvic::GPIO4_1 => gpio::PORT[3].handle_interrupt(),
                        nvic::GPIO4_2 => gpio::PORT[3].handle_interrupt(),
                        nvic::GPIO5_1 => gpio::PORT[4].handle_interrupt(),
                        nvic::GPIO5_2 => gpio::PORT[4].handle_interrupt(),
