...
impl KernelResources<ChipHw> for QemuArmMps2An386 {
...
pub unsafe fn main() {
    ...
    board_kernel.kernel_loop::<QemuArmMps2An386, ChipHw, { NUM_PROCS as u8 }>(
        platform,
        chip,
        None,
