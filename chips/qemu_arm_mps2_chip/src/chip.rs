...
//! Top-level chip definition for the ARM MPS2 AN385/AN386 FPGA images.
//!
//! an385 (Cortex-M3) and an386 (Cortex-M4) share an identical peripheral
//! map (`hw/arm/mps2.c`'s `mps2_common_init`), differing only in CPU core,
//! so this is generic over the [`cortexm::CortexMVariant`] the board
//! chooses.
