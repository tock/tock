...
usage: ./gen_x86_handler_stubs.py [path/to/handler_stubs.s]

If path/to/handler_stubs.s is omitted, then a default path is used.
"""
...
DEFAULT_STUB_FILE = os.path.normpath(
    os.path.join(
        ...
        "../arch/x86/src/interrupts/handler_stubs.s",
    )
)
